...
<p align="center">Download the demo app  <a href="https://github.com/HBiSoft/HBRecorder/releases/download/3.0.2/HBRecorderDemo.apk"><nobr>here</nobr></a></p>
...
```java
dependencies {
    implementation 'com.github.HBiSoft:HBRecorder:3.0.2'
}
```
